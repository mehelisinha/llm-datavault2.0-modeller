...
from dv_components.project_level.base import DVProjYmlBaseGenerator

from dbt_builder.src.dv_components.pydantic_model.discriminator import DVPackagesModel
from shared.src.logger.default_logger import default_logger


class DVPackagesModel(DVProjYmlBaseGenerator):
