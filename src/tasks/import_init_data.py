...
from src.scripts.poc_runner_oop import PocRunner, Config
...
poc_runner = PocRunner(catalog = catalog, raw_vault_schema="raw_vault",
                       dbt_project_dir = config.DBT_PROJECT_DIR, models_output = config.DEFAULT_MODELS_OUTPUT,
