...
from src.dv_components.project_level.base import DVProjYmlBaseGenerator

from shared.infra.file_manager.concrete.yml_handler import YamlHandler
from src.dv_components.pydantic_model.proj_level.dv_yml import DVProjectModel


class DBTProject(DVProjYmlBaseGenerator):
...
if __name__ == "__main__":
    ...
    dbt_project = DBTProject(model=link_model, logger=default_logger)
