...
- [2.1 System Overview Diagram](#21-system-overview-diagram)
...
- [5.1 Core Data Vault Framework](#51-core-data-vault-framework)
- [5.2 Supporting DBT Packages](#52-supporting-dbt-packages)
- [5.3 Python Libraries for Project Builder](#53-python-libraries-for-project-builder)
- [5.4 Library Recommendation Matrix](#54-library-recommendation-matrix)
- [5.5 Installation Reference](#55-installation-reference)

### 6. Architecture Patterns
- [6.1 Data Vault 2.0 Layers](#61-data-vault-20-layers)
- [6.2 Hub-Link-Satellite Relationships](#62-hub-link-satellite-relationships)
...
- [ ] DBT Builder
    ...
    - [ ] Supporting Generators
        ...
        - PIT (optional but recommended early)
        - Bridge (optional)
    - [ ] Macro Generation
        - hash macro
        - surrogate key macro
...
Orchestration         | Databricks Workflows, Airflow, Prefect
Code Generation       | Python OOP + Jinja2 Templates
Transform Engine      | DBT 1.6+ + AutomatedDV Package
Execution Platform    | Databricks (Apache Spark)
Storage Layer         | Databricks Delta Lake (ACID, Time Travel)
Testing & Validation  | dbt tests + Great Expectations + pytest
Logging & Audit       | Delta tables + Databricks Event logs
Documentation         | DBT native docs + Auto-generated Markdown
Version Control       | Git + DBT artifacts
CI/CD Pipeline        | GitHub Actions / Azure DevOps Pipelines
...
### ✅ Metadata Management
- Store metadata in version-controlled CSV files (easier Git diffs)
...
- Partition large Delta tables by load_date for performance
