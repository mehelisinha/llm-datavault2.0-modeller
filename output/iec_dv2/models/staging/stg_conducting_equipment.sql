...
{%- set hashed_columns     = {'HK_CONDUCTING_EQUIPMENT': ['mrid'], 'HASHDIFF_CE_OPERATIONAL': {'is_hashdiff': True, 'columns': ['in_service', 'asset_status']}, 'HASHDIFF_CE_DETAILS': {'is_hashdiff': True, 'columns': ['name', 'equipment_type', 'base_voltage_kv', 'manufacturer', 'model', 'serial_number']}} -%}
