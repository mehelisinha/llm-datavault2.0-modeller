...
{%- set source_model   = {'bronze': 'connectivity_nodes'} -%}
...
{%- set hashed_columns     = {'HK_CONNECTIVITY_NODE': ['mrid'], 'HASHDIFF_CONNECTIVITY_NODE_DETAILS': {'is_hashdiff': True, 'columns': ['name', 'description']}} -%}
