...
class MultitonMixin:
    ...
    def as_decorator(
        ...
        def decorator(cls: type[T]) -> type[T]:
            ...
            # Add multiton attributes to class
            cls._multiton_instances = {}
            ...
            # Override __new__ to implement multiton
            original_new = cls.__new__

            def __new__(cls_inner, *args, **kwargs):
                # Create instance using original __new__
            ...
            # Wrap __init__ to handle multiton logic
            @wraps(original_init)
            def __init__(self, *args, **kwargs):
                ...
                if key in cls._multiton_instances:
                    # Copy attributes from cached instance to this one
                    cached = cls._multiton_instances[key]
                    self.__dict__.update(cached.__dict__)
                else:
                    # Store this as the cached instance
